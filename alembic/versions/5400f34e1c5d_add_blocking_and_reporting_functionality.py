...
def upgrade() -> None:
    ...
    def safe_drop_index(index_name, table_name):
        result = conn.execute(
            sa.text(f"SELECT to_regclass('public.{index_name}')")
        ).scalar()
        if result:
    ...
    safe_drop_index('idx_conversation_last_message', 'conversations')
    safe_drop_index('idx_conversation_participants', 'conversations')
    safe_drop_table('conversations')
    safe_drop_index('idx_participant_conversation_user', 'conversation_participants')
    safe_drop_index('idx_participant_online', 'conversation_participants')
    safe_drop_index('idx_participant_unread', 'conversation_participants')
    safe_drop_index('ix_conversation_participants_id', 'conversation_participants')
    safe_drop_table('conversation_participants')
    safe_drop_index('idx_report_created_at', 'post_reports')
    safe_drop_index('idx_report_post_id', 'post_reports')
    safe_drop_index('idx_report_status', 'post_reports')
    safe_drop_index('ix_post_reports_id', 'post_reports')
    safe_drop_table('post_reports')
    safe_drop_index('idx_comment_parent_id', 'post_comments')
    safe_drop_index('idx_comment_post_created', 'post_comments')
    safe_drop_index('idx_comment_user_id', 'post_comments')
    safe_drop_index('ix_post_comments_id', 'post_comments')
    safe_drop_table('post_comments')
    safe_drop_index('idx_like_comment_id', 'post_likes')
    safe_drop_index('idx_like_created_at', 'post_likes')
    safe_drop_index('idx_like_post_id', 'post_likes')
    safe_drop_index('idx_like_user_id', 'post_likes')
    safe_drop_index('ix_post_likes_id', 'post_likes')
    safe_drop_table('post_likes')
    safe_drop_index('idx_friend_request_receiver_id', 'friend_requests')
    safe_drop_index('idx_friend_request_sender_id', 'friend_requests')
    safe_drop_index('idx_friend_request_status', 'friend_requests')
    safe_drop_table('friend_requests')
    safe_drop_index('idx_close_friend_close_friend_id', 'close_friends')
    safe_drop_index('idx_close_friend_user_id', 'close_friends')
    safe_drop_table('close_friends')
    safe_drop_index('idx_friendship_friend_id', 'friendships')
    safe_drop_index('idx_friendship_status', 'friendships')
    safe_drop_index('idx_friendship_user_id', 'friendships')
    safe_drop_table('friendships')
    safe_drop_index('idx_message_conversation_created', 'messages')
    safe_drop_index('idx_message_replied_to', 'messages')
    safe_drop_index('idx_message_sender', 'messages')
    safe_drop_index('idx_message_status', 'messages')
    safe_drop_table('messages')
    safe_drop_index('idx_post_created_at', 'posts')
    safe_drop_index('idx_post_habit_id', 'posts')
    safe_drop_index('idx_post_habit_streak', 'posts')
    safe_drop_index('idx_post_privacy', 'posts')
    safe_drop_index('idx_post_user_created', 'posts')
    safe_drop_index('ix_posts_id', 'posts')
    safe_drop_table('posts')
    safe_drop_index('idx_view_post_id', 'post_views')
    safe_drop_index('idx_view_user_id', 'post_views')
    safe_drop_index('idx_view_viewed_at', 'post_views')
    safe_drop_index('ix_post_views_id', 'post_views')
    safe_drop_table('post_views')
