...
class PostsService:
    ...
    async def create_post_from_proof(
        ...
        """Create a post from habit proof submission"""
        try:
            ...
            user_basic = UserBasic(
                ...
                first_name=user_result.first_name or "",
                last_name=user_result.last_name or "",
            ...
            logger.info(f"Created post {post.id} from proof for user {user_id}")
            return post_read
